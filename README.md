...
<img width="4971" height="498" alt="mermaid-diagram" src="https://github.com/user-attachments/assets/e8151721-5c8d-4ebd-946a-397dd9a0ddd1" />
...
- Local RAG ưu tiên tuyệt đối: truy xuất `vector_store` trước khi dùng API ngoài.
- Fine-tuned Vietnamese legal embedding: model local tại `vietnamese-embedding-legal`.
